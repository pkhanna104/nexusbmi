classdef decoder < handles
    ...
    methods
        function obj = decoder(dec_name, handles)
            %Establish source
            obj.source = handles.neural_source_name; 
            
            %Make sure it matches source of trained decoder: 
            if ~strcmp(dec_name.source, obj.source)
            
        end
        
        function handles = calc_cursor(feat, handles)
            
            % feat is a lfp band x 1 array 
